...
| `02-§3.5` | Upcoming-camps list renders each camp as a compact one-liner with no separators | 03-ARCHITECTURE.md §14.6 | — (manual: visual check) | `source/assets/cs/style.css` – `.camp-item`, `.camp-body` flex layout | gap |
