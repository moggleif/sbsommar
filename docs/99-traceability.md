...
| `02-§36.11` | Event detail body uses structured layout matching RSS description format | 03-ARCHITECTURE.md §18.2 | EVT-19, EVT-20 | `source/build/render-event.js` | gap |
