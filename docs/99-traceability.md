...
| `02-§18.8` | Before setting the session cookie, the client displays a modal consent prompt on the add-activity form | 03-ARCHITECTURE.md §7 | — | `source/assets/js/client/cookie-consent.js` – `showConsentModal()` | gap |
