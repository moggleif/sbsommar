...
- `<title>` — event title
- `<link>` — absolute URL to the event's per-event detail page (see §35)
...
## 35. Per-Event Detail Pages

Each event in the active camp must have its own static HTML page, generated
at build time. <!-- 02-§35.1 -->

### 35.1 URL structure

Each event page lives in its own sub-folder under `/schema/`: <!-- 02-§35.2 -->
...
Each event page must show: <!-- 02-§35.3 -->
...
Fields with no value must not appear. <!-- 02-§35.4 -->

The `owner` and `meta` fields must never appear on event pages. <!-- 02-§35.5 -->

### 35.3 Layout and navigation

Event pages must use the shared site layout: header navigation, footer,
and stylesheet. <!-- 02-§35.6 -->

Each event page must include a back link to the weekly schedule page. <!-- 02-§35.7 -->

### 35.4 Crawler blocking

Event pages must include the `<meta name="robots" content="noindex, nofollow">`
tag, consistent with all other pages. <!-- 02-§35.8 -->

### 35.5 Build integration

Event pages are generated by `render-event.js` and wired into `build.js`. <!-- 02-§35.9 -->
