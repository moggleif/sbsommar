...
| [02-REQUIREMENTS.md](02-REQUIREMENTS.md) | Requirements index — audience overview and a map to the topic files below |
| [02a-pages-navigation.md](02a-pages-navigation.md) | Site structure, page inventory, navigation, footer, hero CTAs |
| [02b-schedule-and-detail.md](02b-schedule-and-detail.md) | Schedule views, inline activity detail, per-event pages, RSS, iCal, Markdown rendering |
| [02c-add-edit-forms.md](02c-add-edit-forms.md) | Add and edit forms, validation, submit flows, time-gating, drafts, delete |
| [02d-event-data.md](02d-event-data.md) | Event data, locations, archive policy, naming, derived active camp, QA isolation |
| [02e-build-deploy.md](02e-build-deploy.md) | CI pipelines, environments, zero-downtime deploy, release docs, footer version, docs site build |
| [02f-caching-performance.md](02f-caching-performance.md) | Cache headers, content-hash cache-busting, image dimensions and lazy-loading |
| [02g-platform-security.md](02g-platform-security.md) | Reliability, accessibility, language, security hardening, analytics, PWA, admin token, rate limiting |
| [02h-design-and-content.md](02h-design-and-content.md) | Hero redesign, link colors, modal styling, registration banner, locale overview, index design |
| [02z-archive.md](02z-archive.md) | Archived requirements (superseded; IDs preserved) |
