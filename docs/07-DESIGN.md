...
- Day button (`.day-btn`): `min-width: 80px`, `padding: var(--space-xs)
...
- Hover: `border-color: var(--color-sage)`,
  `background: color-mix(in srgb, var(--color-sage) 10%, var(--color-white))`. <!-- 07-§6.79 -->
- Selected (`.day-btn.selected`): `border-color: var(--color-terracotta)`,
  `background: color-mix(in srgb, var(--color-terracotta) 12%, var(--color-cream))`,
  `font-weight: 700`. <!-- 07-§6.80 -->
...
- Recurring toggle (`.recurring-toggle`): styled as a standard form checkbox
  with a label, placed above the day grid. Uses the same typography and spacing
  as other form labels. <!-- 07-§6.83 -->
